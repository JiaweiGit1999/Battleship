...
static class HighScoreController
{
	...
	/// </summary>
	private struct Score : System.IComparable
	{
		public string Name;
		public int Value;
	...
	private static void LoadScores ()
	{
		...
		int numScores = 0;
		numScores = System.Convert.ToInt32 (System.Convert.ToInt32 (input.ReadLine ()));
	...
	public static void DrawHighScores ()
	{
		...
		_giveUpButton.SetText (" Exit", 25);
		_giveUpButton.SetX (700);
		_giveUpButton.SetTextPositionX (710);
		_giveUpButton.SetY (495);
		_giveUpButton.SetTextPositionY (520);

		_HomeButton.SetWidth (160);
		_HomeButton.SetHeight (80);
		_HomeButton.SetText (" Back", 25);
		_HomeButton.SetX (600);
		_HomeButton.SetTextPositionX (605);
		_HomeButton.SetY (495);
		_HomeButton.SetTextPositionY (520);
